        ...
        <div>
          ...
          <div>
            <section>
              ...
              <div className={styles.categoriesLinksContainer}>
                <Link href="/category/men" className={styles.categoryLink}>Ropa para<span>hombres</span></Link>
                <Link href="/category/" className={styles.categoryLink}>Ropa para<span>mujeres</span></Link>
                <Link href="/category/" className={styles.categoryLink}>Ropa para<span>niños</span></Link>
          ...
          <aside>
            <div className={styles.socialContainer}>
              ...
              <p>
                (De momento las redes sociales no están disponibles)
              </p>
